...
void pruebas_abb_alumno() {
	...
	print_test("Guardar clave10 fue logrado exitosamente", abb_guardar(abb2, clave10, NULL) == true );
	print_test("Guardar clave9 fue logrado exitosamente", abb_guardar(abb2, clave9, NULL) == true );
    ...
    print_test("Borrar clave 10", abb_borrar(abb2, clave10) == NULL);
    print_test("Borrar clave 9", abb_borrar(abb2, clave9) == NULL);
    print_test("Borrar clave 1", abb_borrar(abb2, clave1) == NULL);
    print_test("Borrar clave 6", abb_borrar(abb2, clave6) == NULL);
    print_test("Borrar clave 4", abb_borrar(abb2, clave4) == NULL);
    print_test("Borrar clave 7", abb_borrar(abb2, clave7) == NULL);
    print_test("Borrar clave 5", abb_borrar(abb2, clave5) == NULL);
    print_test("Borrar clave 8", abb_borrar(abb2, clave8) == NULL);
    print_test("Borrar clave 3", abb_borrar(abb2, clave3) == NULL);
    print_test("Borrar clave 2", abb_borrar(abb2, clave2) == NULL);
